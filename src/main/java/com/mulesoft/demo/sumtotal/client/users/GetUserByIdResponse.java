...
@XmlRootElement(name = "GetUserByIdResponse", namespace = "http://www.sumtotalsystems.com/sumtotal7/sumtotalws/UserManagement/")
public class GetUserByIdResponse {

    @XmlElement(name = "GetUserByIdResult", required = true, nillable = true)
