...
@XmlType(name = "ArrayOfUserRequiredCompetency", namespace = "http://www.sumtotalsystems.com/sumtotal7/sumtotalws/UserManagement/", propOrder = {
    "userRequiredCompetency"
})
public class ArrayOfUserRequiredCompetency2 {
