...
@XmlType(name = "ArrayOfUserRequiredActivity", namespace = "http://www.sumtotalsystems.com/sumtotal7/sumtotalws/UserManagement/", propOrder = {
    "userRequiredActivity"
})
public class ArrayOfUserRequiredActivity2 {
