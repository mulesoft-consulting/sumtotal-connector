...
@XmlType(name = "ArrayOfUserRequiredSkill", namespace = "http://www.sumtotalsystems.com/sumtotal7/sumtotalws/UserManagement/", propOrder = {
    "userRequiredSkill"
})
public class ArrayOfUserRequiredSkill2 {
