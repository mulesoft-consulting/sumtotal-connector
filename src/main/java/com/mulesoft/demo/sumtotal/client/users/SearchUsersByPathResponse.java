...
@XmlRootElement(name = "SearchUsersByPathResponse", namespace = "http://www.sumtotalsystems.com/sumtotal7/sumtotalws/UserManagement/")
public class SearchUsersByPathResponse {

    @XmlElement(name = "SearchUsersByPathResult", namespace = "http://www.sumtotalsystems.com/sumtotal7/sumtotalws/UserManagement/")
